...
jest.mock('../adapters/shellAdapter', () => ({
  ...jest.requireActual('../adapters/shellAdapter'),
...
describe('openExternal', () => {
  const mockOpenExternalUrl = openExternalUrl as jest.MockedFunction<
    typeof openExternalUrl
  >;
